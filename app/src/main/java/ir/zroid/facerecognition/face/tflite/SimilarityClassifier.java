...
public interface SimilarityClassifier {
  ...
  public class Recognition implements Parcelable {
    ...
    protected Recognition(Parcel in) {
      ...
      extra = (Object) in.readValue(Object.class.getClassLoader());
      location = (RectF) in.readValue(RectF.class.getClassLoader());
      color = in.readByte() == 0x00 ? null : in.readInt();
      crop = (Bitmap) in.readValue(Bitmap.class.getClassLoader());
    }
